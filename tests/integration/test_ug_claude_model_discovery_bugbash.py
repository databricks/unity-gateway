"""Red CUJs for every Claude row in the model-discovery bugbash table."""
...
@pytest.mark.tui
def test_bugbash_case_01_managed_claude_uses_admin_discovery_after_configure(
...
@pytest.mark.tui
def test_bugbash_case_03_managed_claude_ignores_discovery_disable(
    managed_live_session, managed_workspace, managed_claude_model
):
...
def test_bugbash_case_05_managed_claude_rejects_provider_override(
...
def test_bugbash_case_07_managed_claude_rejects_model_location_override(
...
def test_bugbash_case_09_managed_claude_rejects_provider_when_discovery_disabled(
    managed_live_session, managed_workspace, claude_provider
):
...
def test_bugbash_case_11_managed_claude_rejects_model_location_when_discovery_disabled(
    managed_live_session, managed_workspace, parent_schema
):
...
@pytest.mark.tui
def test_bugbash_case_13_configured_claude_reuses_saved_model_location(
...
@pytest.mark.tui
def test_bugbash_case_15_fresh_claude_uses_system_models_when_discovery_disabled(
...
@pytest.mark.tui
def test_bugbash_case_17_configured_claude_provider_discovers_models_by_default(
...
@pytest.mark.tui
def test_bugbash_case_19_configured_claude_model_location_overrides_saved_setup(
    live_session, workspace, parent_schema, claude_parent_model
):
...
@pytest.mark.tui
def test_bugbash_case_21_claude_provider_uses_native_models_when_discovery_disabled(
...
@pytest.mark.tui
def test_bugbash_case_23_claude_location_uses_native_models_when_discovery_disabled(
