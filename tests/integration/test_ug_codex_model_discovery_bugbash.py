"""Red CUJs for every Codex row in the model-discovery bugbash table."""
...
def test_bugbash_case_02_managed_codex_uses_admin_discovery_after_configure(
...
def test_bugbash_case_04_managed_codex_ignores_discovery_disable(
    managed_live_session, managed_workspace, managed_codex_model
):
...
def test_bugbash_case_06_managed_codex_rejects_provider_override(
...
def test_bugbash_case_08_managed_codex_rejects_model_location_override(
...
def test_bugbash_case_10_managed_codex_rejects_provider_when_discovery_disabled(
    managed_live_session, managed_workspace, codex_provider
):
...
def test_bugbash_case_12_managed_codex_rejects_model_location_when_discovery_disabled(
    managed_live_session, managed_workspace, parent_schema
):
...
def test_bugbash_case_14_configured_codex_reuses_saved_model_location(
...
def test_bugbash_case_16_fresh_codex_uses_system_models_when_discovery_disabled(
...
def test_bugbash_case_18_configured_codex_provider_discovers_models_by_default(
...
def test_bugbash_case_20_configured_codex_model_location_overrides_saved_setup(
    live_session, workspace, parent_schema, codex_parent_model
):
...
def test_bugbash_case_22_codex_provider_uses_native_models_when_discovery_disabled(
...
def test_bugbash_case_24_codex_location_uses_native_models_when_discovery_disabled(
