...
class TestManagedMcpServerEntry:
    ...
    def test_mcp_service_needs_three_parts(self):
        ...
        # Also reject 4+ parts
        assert mcp.managed_mcp_server_entry("system.ai.dbsql.extra", "mcp-service", WS) is None
        # And reject empty components
        assert mcp.managed_mcp_server_entry("system..dbsql", "mcp-service", WS) is None
        # Valid case still works
        assert mcp.managed_mcp_server_entry("system.ai.dbsql", "mcp-service", WS) is not None
