...
CodingAgentConfig through the built-in `UCODE_MANAGED_CONFIG_STUB` hook so the real ug
and real agent TUI can be exercised across managed-config shapes the live workspace does
