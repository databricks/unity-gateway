...
| `test_ug_usage_managed_config` | Configure against the dedicated budget-enabled EU West workspace with its target bearer and run `ug usage` | Published managed config is cached; real budget spend, total, percentage, and meter are rendered |
