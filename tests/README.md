...
| `test_case_01_managed_claude_uses_admin_discovery_after_configure` | Restart managed Claude in the same home | Cache timestamp advances past restart time despite an existing fresh cache; a real file-reading task completes |
