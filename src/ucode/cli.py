...
@app.command("claude-subagent-usage-hook", hidden=True)
def claude_subagent_usage_hook_cmd() -> None:
    """Record one completed Claude Code subagent in a local session CSV."""
    import json
    import sys
